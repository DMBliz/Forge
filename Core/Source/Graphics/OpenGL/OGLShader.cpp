...
namespace Forge
{
	...
	void OGLShader::Init(const File& source)
	{
		shaderSource = source.GetString();
	...
	void OGLShader::Init(const String& source)
	{
		shaderSource = source;
	...
	String OGLShader::GetBlock(const String& blockName)
	{
	...
	void OGLShader::ResolveUniformLocations(ShaderUniforms& uniforms)
	{
	...
	void OGLShader::SetValuesToUniforms(const ShaderUniforms& uniforms)
	{
		for(int i = 0; i < uniforms.GetSize(); i++)
		{
	...
	void OGLShader::SetValueToUniform(const UniformDescription& desc)
	{
		switch (desc.type)
		{
	...
	void OGLShader::SetSystemValueToUniform(UniformDescription& desc)
	{
